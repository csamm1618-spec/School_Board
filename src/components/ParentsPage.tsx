                  ...
                  filteredParents.map((parent) => (
                    <tr key={parent.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="space-y-1">
                          {parent.parent_student.map((ps: any) => (
                            <div key={ps.id} className="text-sm text-gray-900">
                              {ps.student?.student_name} ({ps.student?.grade})
                            </div>
                          ))}
                        </div>
                      </td>
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-12 text-center">
                      ...
                      <p className="text-gray-500">
                        {searchTerm ? 'No parents found matching your criteria' : 'No parents registered yet'}
                      </p>
                    </td>
                  </tr>
                )}
